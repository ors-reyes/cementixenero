...
const App = () => {
  ...
  return (
    <>
      ...
      <section ref={elementoRef2}><h1 className='c'>{isIntersecting2 ? "dentro" : "fuera"}</h1></section>
      ...
      <section ref={elementoRef}><h1 className='h'>{isIntersecting ? "dentro" : "fuera"}</h1></section>
